...
def parameters(yaml_name: str):
    ...
    # params.checkpoint = "/root/autodl-tmp/ostrack-hivit/output/phase3_final/checkpoints/train/ostrack/proteus_h_phase3/ProTeusH_ep0020.pth.tar"
    params.checkpoint = "/root/autodl-tmp/ostrack-hivit/output/phase1_final/checkpoints/train/ostrack/hivit_base_256/ProTeusH_ep0060.pth.tar"
    # --- 核心修改：添加缺失的测试开关参数 ---
